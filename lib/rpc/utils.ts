...
export function generateProviderUrl(key: string, value: string): string {
  ...
  switch (key) {
    ...
    case 'WEB3_RPC_GATEWAY_360': {
      return tokens[0]
    }
    case 'WEB3_RPC_GATEWAY_57073': {
      return tokens[0]
    }
    case 'WEB3_RPC_GATEWAY_690': {
      return tokens[0]
    }
    case 'WEB3_RPC_GATEWAY_17069': {
      return tokens[0]
    }
    ...
    case 'WEB3_RPC_GATEWAY_13600000': {
      return tokens[0]
    }
    case 'WEB3_RPC_GATEWAY_34443': {
      return tokens[0]
    }
  }
